...
import static com.khauminhduy.currying.Letter.LETTER_CREATOR;
import static com.khauminhduy.currying.Letter.SIMPLE_CURRIED_LETTER_CREATOR;
import static com.khauminhduy.currying.Letter.SIMPLE_LETTER_CREATOR;
...
public class LetterUnitTest {
	...
	private static final Letter LETTER = new Letter(RETURNING_ADDRESS, INSIDE_ADDRESS, DATE_OF_LETTER, SALUTATION, BODY,
			CLOSING);
